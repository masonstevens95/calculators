...
describe('computeDscr (fixture-driven, AE3 coverage)', () => {
  for (const fixture of fixtures) {
    it(fixture.name, () => {
      ...
      expect(r.totals.module).toBeCloseTo(e.moduleTotal, CURRENCY_EPSILON);
      ...
      expect(r.summary.moduleBeforeDiscount).toBeCloseTo(e.moduleBeforeDiscount, CURRENCY_EPSILON);
